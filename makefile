tda:	main.o integer.o linkedlist.o object.o tdalist.o dllnode.o farraylist.o varraylist.o slinkedlist.o slnode.o
	g++ main.o integer.o dllnode.o linkedlist.o object.o tdalist.o varraylist.o farraylist.o slinkedlist.o slnode.o -o tda
